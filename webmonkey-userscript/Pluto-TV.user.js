...
var reinitialize_dom = function() {
  ...
  var html = {
    "head": [
      ...
      'body > #PlutoTV_EPG > #EPG_data > div > div.collapsible div.episodes > ul {',
      '  list-style: none;',
      '  margin: 0;',
      '  padding: 0;',
      '  padding-left: 1em;',
      ...
      'body > #PlutoTV_EPG > #EPG_data > div > div.collapsible div.episodes > ul > li {',
      '  list-style: none;',
      '  margin-top: 0.5em;',
      ...
      'body > #PlutoTV_EPG > #EPG_data > div > div.collapsible div.episodes > ul > li > table {',
      '  min-height: 70px;',
      '}',

      'body > #PlutoTV_EPG > #EPG_data > div > div.collapsible div.episodes > ul > li > table td:first-child {',
      '  font-style: italic;',
      '  padding-right: 1em;',
      '}',

      'body > #PlutoTV_EPG > #EPG_data > div > div.collapsible div.episodes > ul > li > blockquote {',
      '  display: block;',
      ...
      'body > #PlutoTV_EPG > #EPG_data > div > div.collapsible div.episodes > ul > li > button {',
      '  margin: 0.75em 0;',
      '}',

      'body > #PlutoTV_EPG > #EPG_data > div > div.collapsible div.episodes > ul > li > div.icons-container {',
      '}',
...
if (user_options.debug_verbosity >= 5) debugger;
